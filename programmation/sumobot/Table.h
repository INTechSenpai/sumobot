...
#define MARGE_COTE			55		// la marge pour etre en mode perdu sur les cotés
#define MARGE_AVANT			155		// la marge pour etre en mode perdu sur l'avant et l'arriere cotés
